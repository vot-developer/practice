...
class TopologicalSortTest {
    ...
    void sort1() {
        ...
        assertArrayEquals(new Integer[]{3, 2, 1, 0}, result.toArray());
    }
    ...
    void sort2() {
        ...
        assertArrayEquals(new Integer[]{4, 3, 2, 1, 0}, result.toArray());
    }
    ...
    void sort3() {
        ...
        assertArrayEquals(new Integer[]{6, 5, 4, 3, 2, 1, 0}, result.toArray());
    }
}